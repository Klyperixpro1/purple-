...
// 1. Add poster and change preload
c = c.replace(
    /<video playsinline muted autoplay src="\$\{a\}" loop preload="none" style="max-height: 80vh;"><\/video>/g,
...
// 2. Update the click event listener to unmute on first click
